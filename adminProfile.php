										...
										<div class="col-lg-8 offset-lg-2">
											...
											?>
												<div class="form-group row">
													<label for="required-text-input" class="col-lg-2 col-form-label">Admin Name</label>
													<div class="col-lg-10">
														<input class="form-control" type="text" placeholder="Admin Name" id="required-text-input" value="<?php echo $row['adminUserName'];?>" required>
													</div>
                                                </div>
                                                <div class="form-group row">
                                                        ...
                                                        <div class="col-md-8">
                                                            <div class="form-check form-check-inline">
                                                                <label class="custom-control custom-radio">
                                                                    <input id="radioStacked11" name="radio-stacked" type="radio" class="custom-control-input"<?php echo htmlspecialchars ($rdo1Chcked);?>>
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <label class="custom-control custom-radio">
                                                                    <input id="radioStacked22" name="radio-stacked" type="radio" class="custom-control-input" <?php echo htmlspecialchars ($rdo2Chcked);?>>
                                                                    <span class="custom-control-indicator"></span>
