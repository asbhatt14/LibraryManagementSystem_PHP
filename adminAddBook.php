										...
										<div class="col-lg-8 offset-lg-2">
											<form class="form-common valided-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
												<div class="form-group row">
													...
													<div class="col-lg-10">
														<input class="form-control" type="text" name="bookName" placeholder="Book Name" id="required-text-input" required>
													</div>
                                                </div>
                                                <div class="form-group row">
													<label for="required-text-input" class="col-lg-2 col-form-label">Author Name</label>
													<div class="col-lg-10">
														<input class="form-control" type="text" name="author" placeholder="Author Name" id="required-text-input" required>
													</div>
                                                </div>
                                                <div class="form-group row">
													<label for="required-text-input" class="col-lg-2 col-form-label">Publisher Name</label>
													<div class="col-lg-10">
														<input class="form-control" type="text" name="publisherName" placeholder="Publisher Name" id="required-text-input" required>
													</div>
                                                </div>
                                                <div class="form-group row">
													<label for="text-input-max-character" class="col-lg-2 col-form-label">Edition</label>
													<div class="col-lg-10">
														<input class="form-control" maxlength="6" name="bookEdition" type="text" placeholder="Book Edition" id="text-input-max-character" required>
													</div>
                                                </div>
                                                <div class="form-group row">
													<label for="text-input-max-character" class="col-lg-2 col-form-label">ISBN No.</label>
													<div class="col-lg-10">
														<input class="form-control" type="text" name="ISBN_num" placeholder="Book ISBN" id="text-input-max-character" required>
													</div>
												</div>
                                                <div class="form-group row">
													<label for="text-input-max-character" class="col-lg-2 col-form-label">Book Price</label>
													<div class="col-lg-10">
														<input class="form-control" type="text" name="bookPrice" placeholder="Book Price" id="text-input-max-character" required>
													</div>
                                                </div>
                                                <div class="form-group row">
													<label for="text-input-max-character" class="col-lg-2 col-form-label">Total Copies Available</label>
													<div class="col-lg-10">
														<input class="form-control" type="text" name="numOfCopies" placeholder="Number of Copies Available" id="text-input-max-character" required>
													</div>
												</div>
												<div class="offset-2">
