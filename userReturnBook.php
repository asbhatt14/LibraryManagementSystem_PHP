...
$resultTranscation = mysqli_query($databaseConnection->conn1, $sqlTranscation);
...
// 	 header('Location: bookReturnTranscation.php?transcationId=', urlencode($transcationId),'');
                                                    ...
                                                    <table id="basic_datatable" class="display table table-bordered basic-data-table">
							 						...
							 						if(mysqli_num_rows($resultTranscation) > 0) {
														...
														?>														
															...
															<td><input type="button" class="rent_Button" onClick='location.href="bookReturnTranscation.php?transcationId=<?php echo $row['transcationId']?>&returnDate=<?php echo $returnDate?>"' name="ReturnBook" value="Return Book"  <?php if ($numOfBooksRent1 >= '10000'){ ?> disabled <?php   } ?>   /></td>
                                                            </tr>
															<?php				 
																}
															}
